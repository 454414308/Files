...
_constant() {
    ...
    cyan='\033[1;36m'
    endc='\033[0m'
    onev4=("1101 -n 1" "1103 -n 1" "1102 -n 1")
    fivev4=("1101 -n 5" "1103 -n 5" "1102 -n 5")
    tenv4=("1101 -n 10" "1103 -n 10" "1102 -n 10")
    onev6=("1101 -n 1 -6" "1103 -n 1 -6" "1102 -n 1 -6")
    fivev6=("1101 -n 5 -6" "1103 -n 5 -6" "1102 -n 5 -6")
    tenv6=("1101 -n 10 -6" "1103 -n 10 -6" "1102 -n 10 -6")
    name=("广州电信" "广州移动" "广州联通")
}
check_ipv4() {
